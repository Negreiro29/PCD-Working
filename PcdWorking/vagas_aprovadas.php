    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        function atualizaVagas(){
          $.ajax({
            url: 'vagas_vinculadas.php',
            success: function(data){
              $('#vagas_vinculadas').html(data);
       ...
       <div class="container">
           <div class="row">
               ...
               <div class="col-md-4 conteudo">
                    ...
                    <div class="list-group" id="vagas_vinculadas"  style="border: 2px solid #003399; border-radius: 10px; max-width: 50%; margin-left: 25%;" >
