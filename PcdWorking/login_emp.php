       ...
       <div class="container">
           <div class="row align-items-center">
               ...
               <div class="col-md-4 conteudo">
                  ...
                  <div id="blocos-login">
                    <form method="post" action="validar_acesso_emp.php" class="form-group" id="form-login">
                      <h5 style="text-align: center;">Entrar como empresa!</h5>
                      <p style="text-align: center;"><a href="login.php">Voltar a login de canditado</a></p>
                      <div>
                        <label>Email</label>
                        <input type="email" class="form-control" id="email_empresa" placeholder="Seu email" name="email" style="margin-bottom: 10px;">
                      </div>
                      <div>
                        <label>Senha</label>
                        <input type="password" class="form-control red" id="senha_empresa" placeholder="senha" name="senha" style="margin-bottom: 10px;">
                      </div>
