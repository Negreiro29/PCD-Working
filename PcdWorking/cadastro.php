               ...
               <div class="col-md-4 conteudo">
                   ...
                   <div id="blocos-cadastro">
                     <form method="post" action="registra_usuario.php" id="formCadastrese">
                        <h5 style="text-align: center;">É uma empresa? Cadastre-se <a href="cadastro2.php">aqui!</a></h5>
                        <div class="form-group">
                          <label>Nome Completo</label>
                          <input type="text" class="form-control" placeholder="Nome Completo" id="nome_usuario" name="nomeUsuario">

                          <label>CPF</label>
                          <input type="text" class="form-control" placeholder="CPF" id="cpf" name="cpf">
                          <?php
                            if($erro_cpf){
                              echo '<font style="color:#FF0000">CPF já cadastrado!<font> <br/>';
                            }
                          ?>
                          ...
                          <label>Email</label>
                          <input type="email" class="form-control" placeholder="Seu Email" id="email_usuario" name="emailUsuario">
                          <?php
                            if($erro_email) {
                              echo '<font style="color:#FF0000">Email já cadastrado!<font> <br/>';
                            }
                          ?>

                          <label>Senha</label>
                          <input type="password" class="form-control" placeholder="Senha" id="senha_usuario" name="senhaUsuario">
                        </div>
