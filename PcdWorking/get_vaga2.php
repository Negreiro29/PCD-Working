<?php
	...
	$sql = "SELECT v.id_empresa, v.cargo, v.salario, v.local_vaga, v.uf, date_format(v.data_inclusao, '%d %b %Y %T') AS data_inclusao_formatada, e.nome_fantasia FROM vagas AS v JOIN empresas AS e ON (v.id_empresa = e.id_empresa) WHERE v.id_empresa = '$id_empresa' ORDER BY data_inclusao DESC";
