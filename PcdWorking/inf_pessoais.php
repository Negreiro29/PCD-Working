           ...
           <div class="row align-items-center">
               ...
               <div class="col-md-4 conteudo">
                    ...
                    <div id="blocos-info" style="text-align: justify;">
                      <h5>ID: <?= $_SESSION['id_usuario']?></h5>
                      <h5>Nome: <?= $_SESSION['nome']?></h5>
                      <h5>Sexo: <?= $_SESSION['sexo']?></h5>
                      <h5>Deficiência: <?= $_SESSION['deficiencia']?></h5>
                      <h5>cpf: <?= $_SESSION['cpf']?></h5>
                      <h5>Emial: <?= $_SESSION['email']?></h5>
                      <h5>Senha: *******</h5>
                      <button type="input" class="btn btn-primary" id="btn-acesso"><a href="perfil.php" style="color: white;">Voltar</a></button>
                    </div>
