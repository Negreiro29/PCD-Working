       ...
       <div class="container">
           <div class="row align-items-center">
               ...
               <div class="col-md-4 conteudo">
                    ...
                    <div id="blocos-info">
                      <h5>Infomações da empresa.</h5>
                      <p>Aqui você terá acesso as informações da empresa <?= $_SESSION['nome']?>!</p>
                      <button type="input" class="btn btn-primary" id="btn-acesso"><a href="inf_empresa.php" style="color: white;">Acessar</a></button>
                    </div>

                    <div id="blocos-info">
                      <h5>Vagas cadastradas</h5>
                      <p>Aqui você poderá cadastrar novas vagas anunciando como <?= $_SESSION['nome']?></p>
                      <button type="input" class="btn btn-primary" id="btn-acesso"><a href="vagas_cadastradas.php" style="color: white;">Acessar</a></button>
                    </div>
