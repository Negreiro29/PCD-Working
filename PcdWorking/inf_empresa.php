       ...
       <div class="container">
           <div class="row align-items-center">
               ...
               <div class="col-md-4 conteudo">
                    ...
                    <h3 style="text-align: center;">Informações da empresa!</h3>
                    <div id="blocos-info" style="text-align: justify;">
                      <h5>Razão social: <?= $_SESSION['razaosocial']?></h5>
                      <h5>Nome fantasia: <?= $_SESSION['nome']?></h5>
                      <h5>CNPJ: <?= $_SESSION['cnpj']?></h5>
                      <h5>Emial: <?= $_SESSION['email']?></h5>
                      <h5>Senha: *******</h5>
                      <button type="input" class="btn btn-primary" id="btn-acesso"><a href="perfil_emp.php" style="color: white;">Voltar</a></button>
                    </div>
