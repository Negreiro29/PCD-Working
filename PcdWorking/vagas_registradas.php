       ...
       <div class="container">
           <div class="row">
               ...
               <div class="col-md-4 conteudo">
                    ...
                    <div class="list-group" id="vagas_regis"  style="border: 2px solid #003399; border-radius: 10px; max-width: 50%; margin-left: 25%;" >
       ...
       <div class="container" id="links-rodape">
           <div class="row">
               <div class="col-md-6">
                   <h6>Navegação</h6>
                   <ul>
                       <li><a href="vagas_cadastradas.php">Vagas</a></li>
