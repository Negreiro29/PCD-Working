       ...
       <div class="container">
           <div class="row align-items-center">
               ...
               <div class="col-md-4 conteudo">
                    ...
                    <div id="blocos-info">
                      <h5>Infomações pessoais</h5>
                      <p>Aqui você terá acesso as informações pessoais de <?= $_SESSION['nome']?>!</p>
                      <button type="input" class="btn btn-primary" id="btn-acesso"><a href="inf_pessoais.php" style="color: white;">Acessar</a></button>
                    </div>

                    <div id="blocos-info">
                      <h5>Vagas vinculadas</h5>
                      <p>Aqui você terá acesso as vagas em que <?= $_SESSION['nome']?> se candidatou</p>
                      <button type="input" class="btn btn-primary" id="btn-acesso"><a href="vagas_aprovadas.php" style="color: white;">Acessar</a></button>
                    </div>
