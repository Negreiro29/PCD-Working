       ...
       <div class="container">
           <div class="row align-items-center">
               ...
               <div class="col-md-12">
                   ...
                   <ul class="top-menu">
                       <li><a href="home_emp.php">Início</a></li>
                       <li>|</li>
                       <li><a href="vagas_registradas.php">Vagas</a></li>
                       <li>|</li>
                       <li><a href="perfil_emp.php">Perfil</a></li>
                       <li>|</li>
           ...
           <div class="row align-items-center">
               ...
               <div class="col-md-4 conteudo">
                    ...
                    <div id="blocos-cadastro">
                      <form method="post" action="criar_vagas.php">
                        <h3 style="text-align: center;">Cadastrar vaga</h3>
                        <div>
                          <label>Cargo</label>
                          <input type="text" class="form-control" placeholder="Informe o cargo desta vaga" id="cargo" name="cargo">
                        </div>
                        <div>
                          <label for="dinheiro">Salario</label>
                          <input type="number" class="dinheiro form-control" placeholder="Informe o salario ofertado para esta vaga" id="salario" name="salario">
                        </div>
                        <div>
                          <label>Cidade</label>
                          <input type="text" class="form-control" placeholder="Informe onde fica a localidade desta vaga" id="cidade" name="cidade">
                        </div>
                        <div>
                          <label>Estado</label>
                          <div>
                        ...
                        <button type="button" class="btn btn-primary" style="margin-top: 10px;"><a href="perfil_emp.php" style="color: white;">Voltar</a></button>
       ...
       <div class="container" id="links-rodape">
           <div class="row">
               <div class="col-md-6">
                   ...
                   <ul>
                       <li><a href="vagas_registradas.php">Vagas</a></li>
                       <li><a href="home_emp.php">Inicio</a></li>
                       <li><a href="sair.php">Sair</a></li>
                   </ul>
               </div>
