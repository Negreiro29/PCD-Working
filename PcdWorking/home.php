    ...
    <script type="text/javascript">
      $(document).ready( function(){
        $('#btn-pesquisa').click(function(){
          if ($('#procurar_vagas').val().length > 0) {
            $.ajax({
              url: 'get_pesquisa.php',
              method: 'post',
              data: $('#form-pesquisar').serialize(),
              success: function(data){
                window.location.replace("resultado_pesquisa.php");
                //window.location.replace("resultado_pesquisa.php").($('#resultado_busca').html(data));
                //window.location.replace("resultado_pesquisa.php?resultado_busca="+html(data));
              }
            });
          }
           ...
           <div class="row align-items-center">
               ...
               <div class="col-md-12">
                   ...
                   <ul class="acess-menu">
                     ...
                     <li>|</li>
                     <li>
                       <form class="d-flex" id="form-pesquisar">
                         <input class="form-control me-2" type="search" placeholder="Pesquisar vagas" id="procurar_vagas" name="procurar_vagas">
                         <button class="btn btn-outline-info" id="btn-pesquisa" type="search">
           ...
           <div class="row align-items-center">
               ...
               <div class="col-md-4 conteudo">
                ...
                <div id="saudacoes" id="blocos-info">
                        <h1>PCD WORKING</h1>
                        <p>Olá, <?= $_SESSION['nome']; ?>! Bem vindo ao PCD Working!</p>
                    </div>
